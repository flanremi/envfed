...
if __name__ == '__main__':
    for _type in range(1 + len(n_steps)):
        ...
        agent = net.DDQN(device, 2 + 16 * (25 + 1), 25 + 1, area)
        agent2 = net2.DDQN(device, 2 + 16 * (25 + 1), 25 + 1, area)
            ...
            while True:
                ...
                if _type == 0:
                    ...
                    if done == 1:
                        ...
                        with open("C:\\Users\\lily\\PycharmProjects\\zhangruoyi\\yolov5\\dqn\\{}_result".format(area), "w+") as file:
                    ...
                    if done == 1:
                        ...
                        latency_data.append(env.latency)
                        print(str(_type) + "=============" + str(i_episode) + "=============" + str(env.last_reward))
                        with open("C:\\Users\\lily\\PycharmProjects\\zhangruoyi\\yolov5\\dqn\\{}_nstep_result".format(area), "w+") as file:
                            file.write(json.dumps({"reward":reward_data, "loss":loss_data, "steps":steps,
                                                   "latency":latency_data, "dqn_loss":dqn_loss}))
                        break
