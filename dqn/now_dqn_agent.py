...
class DDQN:
    ...
    # tensor([0.13314, 0.18935, 0.15639, 0.24796, 0.16494, 0.28855, 0.17646, 0.20894, 0.28648, 0.14962], device='cuda:0', grad_fn=<ViewBackward0>)
    # tensor([0.12216, 0.20963, 0.15767, 0.18634, 0.16399, 0.29794, 0.16810, 0.18192, 0.30317, 0.14315], device='cuda:0', grad_fn=<ViewBackward0>)
    def save_net(self):
        global current_path
    ...
    def update(self, transition_dict):
        ...
        B = A.topk(3, dim=1)
        max_next_q_values = B[0].sum(dim=1, keepdim=True)
